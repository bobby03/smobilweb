...
<!--	<div class="row hide" data-id="2">
            <?php echo $form->dropDownList($model,'id_solicitudes', Solicitudes::model()->getSolicitudes(3), array('empty'=>'Seleccionar', 'class'=>'css-select','style'=>'height:30px')); ?>
	</div>-->
	...
	<div class="row hide" data-id="4">
            <?php echo $form->dropDownList($model,'id_estacion', Estacion::model()->getAllEstacionMovil(), array('empty'=>'Seleccionar', 'class'=>'css-select','style'=>'height:30px')); ?>
	</div>
