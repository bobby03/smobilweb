...
<?php $form=$this->beginWidget('CActiveForm', array(
 ...
 <?php echo CHtml::dropDownList('searchDropDown', 'id', $model->getSearchViajes(),array('empty' =>'Selecciona campo a buscar','data-s'=>1)); ?>
	...
	<div class="row hide" data-id="3">
	 <?php echo $form->dropDownList($model,'id', CampSensado::model()->getProduccionName(1), array('empty'=>'Seleccionar', 'class'=>'css-select')); ?>
	</div>
	
	<div class="row hide" data-id="4">
	<?php echo $form->dropDownList($model,'id', CampSensado::model()->getResponsableName(1), array('empty'=>'Seleccionar', 'class'=>'css-select')); ?>
