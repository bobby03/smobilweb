...
class TbButtonColumn extends CButtonColumn
{
	...
	public $deleteButtonIcon = 'trash';
        ...
        public $materialsButtonIcon = 'file';
	public $materialsButtonLabel = 'Materiales';
	public $materialsButtonImageUrl ;
	public $materialsButtonUrl = 'Yii::app()->controller->createUrl("create",array("id"=>$data->primaryKey))';
	public $materialsButtonOptions = array('class'=>'materials');
	
	public $customButtonIcon = 'picture';
	public $customButtonLabel = 'Galería';
	public $customButtonImageUrl ;
	public $customButtonUrl = 'Yii::app()->controller->createUrl("create",array("id"=>$data->primaryKey))';
	public $customButtonOptions = array('class'=>'custom');
