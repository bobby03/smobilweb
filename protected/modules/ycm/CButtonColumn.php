...
class CButtonColumn extends CGridColumn
{
	 ...
	 */
	public $template='{view} {update} {delete} {custom} {materials}';
	/**
	 ...
	 */
	// public $galleryButtonLabel = 'Galería';
	// public $galleryButtonImageUrl ;
	// public $galleryButtonUrl = 'Yii::app()->controller->createUrl("create",array("id"=>$data->primaryKey))';
	// public $galleryButtonOptions = array('class'=>'gallery');
	...
	protected function initDefaultButtons()
	{
		...
		if($this->customButtonImageUrl===null)
			$this->customButtonImageUrl=$this->grid->baseScriptUrl.'/view.png';
		if($this->materialsButtonLabel===null)	
			$this->materialsButtonLabel=Yii::t('zii','Materials');
		if($this->materialsButtonImageUrl===null)
			$this->materialsButtonImageUrl=$this->grid->baseScriptUrl.'/file.png';
		...
		foreach(array('view','update','delete','custom', 'materials') as $id)
		{
			$button=array(
